...
TEST(AGMND, can_create_minimizer) {
	ASSERT_NO_THROW(AGMND m(0.0, 0.0, 0.0, 0.0, nullptr));
	ASSERT_NO_THROW(One_Dimensional_AGMND odm(0.0, 0.0, 0.0, nullptr));
}

TEST(AGMND, throw_when_left_border_more_than_right_border_in_odm) {
	ASSERT_ANY_THROW(One_Dimensional_AGMND odm(10.0, 5.0, 0.0, nullptr));
}
TEST(AGMND, throw_when_left_border_more_than_right_border) {
	ASSERT_ANY_THROW(AGMND m(10.0, 5.0, 0.0, 0.0, nullptr));
}

TEST(AGMND, throw_when_lower_border_more_than_upper_border) {
	ASSERT_ANY_THROW(AGMND m(0.0, 5.0, 10.0, 0.0, nullptr));
}
