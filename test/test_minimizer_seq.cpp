...
TEST(minimizer_seq, can_find_min_f1_on_x_axis) {
	double(*fptr)(double, double) = f1;
	result res;
	double delta_x, delta_y, actual_x = 0.0, actual_y = 1.0;
...
TEST(minimizer_seq, can_find_min_f1_on_y_axis) {
	double(*fptr)(double, double) = f1;
	result res;
	double delta_x, delta_y, actual_x = 0.0, actual_y = 1.0;
...
TEST(minimizer_seq, can_find_min_f2) {
...
TEST(minimizer_seq, can_find_min_f2_on_x_axis) {
	double(*fptr)(double, double) = f2;
	result res;
	double delta_x, delta_y, actual_x = 1.0, actual_y = 0.0;
...
TEST(minimizer_seq, can_find_min_f2_on_y_axis) {
	double(*fptr)(double, double) = f2;
	result res;
	double delta_x, delta_y, actual_x = 1.0, actual_y = 0.0;
